...
# vaqtida (UTC+5, yil bo'yi o'zgarmaydi) ko'rsatishimiz kerak — aks
# holda botdagi xabarlarda vaqt 5 soat orqada chiqadi.
...
async def ucorder_ok(call: types.CallbackQuery):
    ...
    try:
        await bot.send_message(
            call.from_user.id,
            format_uc_order_message(row, "Tasdiqlangan"),
            parse_mode="HTML"
        )
    except Exception:
        pass
