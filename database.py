...
def _seed_baraban_prizes(conn):
    ...
    prizes = [
        ("baraban_som0",     "0 so'm",             "💨", 100, 1),
        ("baraban_som50",    "50 so'm",            "💰", 60,  2),
        ("baraban_som100",   "100 so'm",           "💰", 45,  3),
        ("baraban_som1000",  "1000 so'm",          "💰", 35,  4),
        ("baraban_uc180",    "180 UC",             "🪙", 25,  5),
        ("baraban_disc10",   "10% VIP chegirma",   "🏷️", 25,  6),
        ("baraban_som5000",  "5000 so'm",          "💰", 15,  7),
        ("baraban_uc60",     "60 UC",              "🪙", 15,  8),
        ("baraban_disc25",   "25% VIP chegirma",   "🏷️", 10,  9),
        ("baraban_som10000", "10000 so'm",         "💰", 8,   10),
        ("baraban_uc120",    "120 UC",             "🪙", 8,   11),
        ("baraban_prem15",   "15 kunlik premium",  "💎", 5,   12),
        ("baraban_disc50",   "50% VIP chegirma",   "🏷️", 3,   13),
        ("baraban_prem1m",   "1 oylik premium",    "💎", 3,   14),
        ("baraban_elite",    "Elite Pass",         "🎫", 2,   15),
        ("baraban_prem1y",   "1 yillik premium",   "💎", 1,   16),
    ]
