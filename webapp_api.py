...
# Fayllar Render'dagi persistent disk ichiga saqlanadi (render.yaml'da
# DB_PATH bilan bir xil disk /data ga mount qilingan), aks holda har safar
# qayta deploy qilinganda yuklangan rasmlar (avatar, vazifa logotiplari)
# yo'qolib ketadi, chunki loyihaning o'z papkasi har deployda tozalanadi.
_DB_DIR = os.path.dirname(os.path.abspath(os.environ.get("DB_PATH", "cloude.db")))
_UPLOADS_ROOT = os.path.join(_DB_DIR, "uploads") if _DB_DIR else os.path.join(
